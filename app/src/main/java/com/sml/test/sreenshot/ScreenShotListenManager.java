...
public class ScreenShotListenManager {
    ...
    public void startListen() {
        ...
        boolean notifyForDescendants = Build.VERSION.SDK_INT >= 29;
...
//                    MediaStore.Images.ImageColumns.DATE_ADDED + " desc limit 1"
            ...
            if (cursor == null) {
                Log.i("smlllll", "Deviant logic. ");
                return;
            }
            if (!cursor.moveToFirst()) {
                Log.i("smlllll", "Cursor no data.");
                return;
            }
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        Log.i("smllll", "ScreenShot: path --- " + data + "; size = " + width + " * " + height
                + "; date = " + dateTaken);
        if (checkScreenShot(data, dateTaken, width, height)) {
            ...
            Log.i("smllll", "Media content changed, but not screenshot: path = " + data
